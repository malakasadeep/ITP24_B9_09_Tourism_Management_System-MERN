    ...
    const fetchPackage = async () => {
      try {
        ...
        const response = await fetch(
          `/api/Package/get-update/${params.packageId}`
        );
              ...
              <div>
                {packagee.hoteltype && (
                  <div>
                    ...
                    <p className="text-sm font-serif text-slate-900 m-7 mt-0 text-center justify-center">
                      {packagee.hoteltype}
                    </p>
                  </div>
                )}
              ...
              <div>
                {packagee.specialactivities && (
                  <div>
                    ...
                    <p className="text-sm font-serif text-slate-900 text-center justify-center m-7 mt-0">
                      {packagee.specialactivities}
                    </p>
                  </div>
                )}

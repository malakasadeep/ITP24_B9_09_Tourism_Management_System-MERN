...
export default function UpdatePkg() {
  ...
  useEffect(() => {
    const fetchPackage = async () => {
      ...
      const res = await fetch(`/api/Package/get-update/${packageId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setLoading(true);
      setError(false);
      const res = await fetch(`/api/package/update/${params.packageId}`, {
        method: "POST",
        headers: {
    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form className="flex flex-col sm:flex-row gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              <input
                ...
                min="1"
                max="20"
                className="p-3  border-blue-300 rounded-lg"
                required
                onChange={handleChange}
                value={formData.days}
              />
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col items-center">
                <p>Reguler Price</p>
                {formData.type === "reguler" && (
                  <span className="text-xs">($ / Per Person)</span>
                )}
                {formData.type === "couple" && (
                  <span className="text-xs">($ / Per 2 Person)</span>
                )}
                {formData.type === "family" && (
                  <span className="text-xs">($ / Per 4 Person)</span>
                )}
              </div>
            </div>
            {formData.offer && (
          ...
          <div className="flex gap-4 flex-wrap">
            <div className="flex gap-2">
              <input
                ...
                className="w-5"
                onChange={handleChange}
                checked={formData.hoteltype === "3 Star Hotel"}
              />
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-5"
                onChange={handleChange}
                checked={formData.hoteltype === "4 Star Hotel"}
              />
              <span className="text-2xl"> &#9733; &#9733; &#9733; &#9733;</span>
            </div>
            <div className="flex gap-2">
              <input
                ...
                className="w-5"
                onChange={handleChange}
                checked={formData.hoteltype === "5 Star Hotel"}
              />
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          >
            {loading ? "Loading" : "Update the Package"}
          </button>

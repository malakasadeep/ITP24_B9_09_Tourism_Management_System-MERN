...
export default function UpdatePkg() {
  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
        <h1 className='text-3xl font-semibold text-center my-7 mt-24'>Update Package</h1>
        ...
        <form className='flex flex-col sm:flex-row gap-4' onSubmit={handleSubmit}>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80' disabled={loading || uploading}>{loading ? 'Loading' : 'Update the Package'}</button>

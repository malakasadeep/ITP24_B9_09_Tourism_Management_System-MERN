    ...
    <div className="mb-10 mt-24">
      <div className="p-3 max-w-lg mx-auto bg-white/10 z-10 backdrop-filter backdrop-blur-lg shadow-lg rounded-2xl">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-2">
          ...
          <p className="bg-green-700 text-yellow-200 rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80 text-center">
            Reset Password
          </p>
          <span
            onClick={handleDeleteUser}
            className="bg-red-700 text-yellow-200 rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80 text-center cursor-pointer"
          >
            Delete account
          </span>
        </form>

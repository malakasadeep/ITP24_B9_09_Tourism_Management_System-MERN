          ...
          <datalist id='city'>
            ...
            <option value='Negombo'></option>
              ...
              <div className='flex flex-col flex-1 gap-4'>
                  ...
                  <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80' disabled={loading}>{loading ? 'Loading' : 'Update the Vehicle'}</button>

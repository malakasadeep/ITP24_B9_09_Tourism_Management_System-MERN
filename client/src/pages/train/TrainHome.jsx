  ...
  return (
    <div className="mt-28">
      ...
      <div className="flex  items-center bg-white mt-4 lg:mt-[-52px] px-8 shadow-lg max-w-[1240px] max-l-[240px]  p-4 lg:text-left text-center h-full mx-auto rounded-lg">
        <form
          className="flex flex-wrap lg:flex-row justify-between px-0"
        ...
        >
          ...
          <div className="mx-auto">
            <button className="bg-transparent mt-5 mb-5 hover:bg-blue-500 text-blue-900 font-semibold text-2xl  hover:text-white border border-blue-900 hover:border-transparent rounded ml-10 px-16">
              Search
            </button>
          </div>
        </form>

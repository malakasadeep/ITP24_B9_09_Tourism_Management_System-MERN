        ...
        >
          <div className="flex flex-col gap-4 flex-1">
            ...
            <div className="flex flex-wrap gap-6">
              <div className="flex items-center gap-2">
                <select
                  id="from"
                  name="from"
                  className="p-3 border border-blue-300 rounded-lg w-60"
                  required
                  onChange={handleChange}
                  value={formData.from}
                >
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? "Loading" : "Add the Train"}
            </button>
            <Link className="p-3 bg-red-700 text-white text-center rounded-lg uppercase hover:opacity-95 disabled:opacity-80">
              Cancel
            </Link>
